 ...
 *
 * Global skills live in ~/.pi/agent/pi-hermes-obsidian-memory/skills/<slug>/SKILL.md.
...
import { AGENT_ROOT, resolveDefaultGlobalDir } from "../paths.js";
...
export class SkillStore {
  ...
  constructor(options: SkillStoreOptions = {}) {
    ...
    const defaultDir = resolveDefaultGlobalDir();
    this.globalSkillsDir = options.globalSkillsDir ?? path.join(defaultDir, "skills");
    ...
    this.migrationSentinelPath = options.migrationSentinelPath
      ?? path.join(defaultDir, ".skills-migrated-to-extension-storage");
  }
